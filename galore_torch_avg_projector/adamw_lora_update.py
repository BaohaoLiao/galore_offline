        ...
        for group in self.param_groups:
            ...
            for i, p in enumerate(group["params"]):
                if "rank" in group:
                    ...
                    # simplified version for the case where there is lora_A and lora_B
                    p_lora_A_p, grad_lora_A = lora_ABs_cp[nn_data["lora_A"]], p_norm_grad[nn_data["lora_A"]]
                    p_lora_B, grad_lora_B = lora_ABs_cp[nn_data["lora_B"]], p_norm_grad[nn_data["lora_B"]]
