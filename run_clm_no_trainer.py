...
def main():
    ...
    # Get the datasets
    train_data = load_dataset("json", data_dir=args.dataset_dir, split="train", streaming=True)
    ...
    train_dataset = PreprocessedIterableDataset(
        train_data, tokenizer, batch_size=args.per_device_train_batch_size, max_length=args.max_length
    )
    # Log a few random samples from the training set:
    for index in random.sample(range(len(train_dataset)), 3):
        logger.info(f"Sample {index} of the training set: {train_dataset[index]}.")
    train_dataloader = DataLoader(train_dataset, batch_size=None, num_workers=args.preprocessing_num_workers)
    ...
    if args.optimizer.lower() == "adamw":
        ...
        optimizer = GaLoreAdamW(param_groups, lr=args.learning_rate, weight_decay=args.weight_decay)        
    ...
    # Scheduler
    lr_scheduler = training_utils.get_scheculer(
        optimizer=optimizer,
