...
from galore_torch_avg_projector import GaLoreAdamWProj
...
def main(args):
    ...
    elif args.optimizer.lower() == "galore_adamw_proj":
        # redefine way to call galore_adamw
        optimizer = GaLoreAdamWProj(param_groups, lr=args.lr, weight_decay=args.weight_decay)
    # implement sgd
